...
#define CASE_ROCMFP_RDNA2(T, LAYOUT) \
    CASE(T, 256, 2, 128,  16, LAYOUT, MMQ_ITER_K, false, true); \
    CASE(T, 256, 2, 128,  32, LAYOUT, MMQ_ITER_K, false, true); \
    CASE(T, 256, 2, 128,  64, LAYOUT, MMQ_ITER_K, false, true); \
    CASE(T, 256, 2, 128,   8, LAYOUT, MMQ_ITER_K, false, false); \
    CASE(T, 256, 2, 128,  16, LAYOUT, MMQ_ITER_K, false, false); \
    CASE(T, 256, 2, 128,  24, LAYOUT, MMQ_ITER_K, false, false); \
    CASE(T, 256, 2, 128,  32, LAYOUT, MMQ_ITER_K, false, false); \
    CASE(T, 256, 2, 128,  40, LAYOUT, MMQ_ITER_K, false, false); \
    CASE(T, 256, 2, 128,  48, LAYOUT, MMQ_ITER_K, false, false); \
    CASE(T, 256, 2, 128,  64, LAYOUT, MMQ_ITER_K, false, false)

    CASE_ROCMFP_RDNA2(GGML_TYPE_Q4_0_ROCMFP4,      GGML_CUDA_MMQ_SRAM_LAYOUT_Q3_K);
    CASE_ROCMFP_RDNA2(GGML_TYPE_Q4_0_ROCMFP4_FAST, GGML_CUDA_MMQ_SRAM_LAYOUT_Q8_0);
    CASE_ROCMFP_RDNA2(GGML_TYPE_Q4_0_ROCMI4,       GGML_CUDA_MMQ_SRAM_LAYOUT_Q8_0);
    CASE_ROCMFP_RDNA2(GGML_TYPE_Q3_0_ROCMFPX,      GGML_CUDA_MMQ_SRAM_LAYOUT_Q3_K);
    CASE_ROCMFP_RDNA2(GGML_TYPE_Q2_0_ROCMFPX,      GGML_CUDA_MMQ_SRAM_LAYOUT_Q3_K);
    CASE_ROCMFP_RDNA2(GGML_TYPE_Q6_0_ROCMFPX,      GGML_CUDA_MMQ_SRAM_LAYOUT_Q3_K);
    CASE_ROCMFP_RDNA2(GGML_TYPE_Q8_0_ROCMFPX,      GGML_CUDA_MMQ_SRAM_LAYOUT_Q8_0);
#undef CASE_ROCMFP_RDNA2
