...
#define CASE_ROCMFP_RDNA3(T, LAYOUT) \
    ...
    CASE_ROCMFP_RDNA3(GGML_TYPE_Q4_0_ROCMFP4,      GGML_CUDA_MMQ_SRAM_LAYOUT_Q3_K);
    CASE_ROCMFP_RDNA3(GGML_TYPE_Q4_0_ROCMFP4_FAST, GGML_CUDA_MMQ_SRAM_LAYOUT_Q8_0);
    CASE_ROCMFP_RDNA3(GGML_TYPE_Q4_0_ROCMI4,       GGML_CUDA_MMQ_SRAM_LAYOUT_Q8_0);
    CASE_ROCMFP_RDNA3(GGML_TYPE_Q3_0_ROCMFPX,      GGML_CUDA_MMQ_SRAM_LAYOUT_Q3_K);
    CASE_ROCMFP_RDNA3(GGML_TYPE_Q2_0_ROCMFPX,      GGML_CUDA_MMQ_SRAM_LAYOUT_Q3_K);
    CASE_ROCMFP_RDNA3(GGML_TYPE_Q6_0_ROCMFPX,      GGML_CUDA_MMQ_SRAM_LAYOUT_Q3_K);
    CASE_ROCMFP_RDNA3(GGML_TYPE_Q8_0_ROCMFPX,      GGML_CUDA_MMQ_SRAM_LAYOUT_Q8_0);
#undef CASE_ROCMFP_RDNA3
