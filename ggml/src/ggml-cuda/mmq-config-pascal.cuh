...
#define CASE_ROCMFP_PASCAL(T, LAYOUT) \
    CASE(T, 256, 2, 64,   8, LAYOUT, MMQ_ITER_K, false, true); \
    CASE(T, 256, 2, 64,  16, LAYOUT, MMQ_ITER_K, false, true); \
    CASE(T, 256, 2, 64,  32, LAYOUT, MMQ_ITER_K, false, true); \
    CASE(T, 256, 2, 64,  64, LAYOUT, MMQ_ITER_K, false, true); \
    CASE(T, 256, 2, 64,   8, LAYOUT, MMQ_ITER_K, false, false); \
    CASE(T, 256, 2, 64,  16, LAYOUT, MMQ_ITER_K, false, false); \
    CASE(T, 256, 2, 64,  24, LAYOUT, MMQ_ITER_K, false, false); \
    CASE(T, 256, 2, 64,  32, LAYOUT, MMQ_ITER_K, false, false); \
    CASE(T, 256, 2, 64,  40, LAYOUT, MMQ_ITER_K, false, false); \
    CASE(T, 256, 2, 64,  48, LAYOUT, MMQ_ITER_K, false, false); \
    CASE(T, 256, 2, 64,  64, LAYOUT, MMQ_ITER_K, false, false)

    CASE_ROCMFP_PASCAL(GGML_TYPE_Q4_0_ROCMFP4,      GGML_CUDA_MMQ_SRAM_LAYOUT_Q3_K);
    CASE_ROCMFP_PASCAL(GGML_TYPE_Q4_0_ROCMFP4_FAST, GGML_CUDA_MMQ_SRAM_LAYOUT_Q8_0);
    CASE_ROCMFP_PASCAL(GGML_TYPE_Q4_0_ROCMI4,       GGML_CUDA_MMQ_SRAM_LAYOUT_Q8_0);
    CASE_ROCMFP_PASCAL(GGML_TYPE_Q3_0_ROCMFPX,      GGML_CUDA_MMQ_SRAM_LAYOUT_Q3_K);
    CASE_ROCMFP_PASCAL(GGML_TYPE_Q2_0_ROCMFPX,      GGML_CUDA_MMQ_SRAM_LAYOUT_Q3_K);
    CASE_ROCMFP_PASCAL(GGML_TYPE_Q6_0_ROCMFPX,      GGML_CUDA_MMQ_SRAM_LAYOUT_Q3_K);
    CASE_ROCMFP_PASCAL(GGML_TYPE_Q8_0_ROCMFPX,      GGML_CUDA_MMQ_SRAM_LAYOUT_Q8_0);
#undef CASE_ROCMFP_PASCAL
