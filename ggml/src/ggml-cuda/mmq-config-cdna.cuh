...
#define CASE_ROCMFP_CDNA(T, LAYOUT) \
    CASE(T, 512, 1, 128,  16, LAYOUT, MMQ_ITER_K, true, true); \
    CASE(T, 512, 1, 128,  32, LAYOUT, MMQ_ITER_K, true, true); \
    CASE(T, 512, 1, 128,  64, LAYOUT, MMQ_ITER_K, true, true); \
    CASE(T, 512, 1, 128,  16, LAYOUT, MMQ_ITER_K, true, false); \
    CASE(T, 512, 1, 128,  32, LAYOUT, MMQ_ITER_K, true, false); \
    CASE(T, 512, 1, 128,  48, LAYOUT, MMQ_ITER_K, true, false); \
    CASE(T, 512, 1, 128,  64, LAYOUT, MMQ_ITER_K, true, false)

    CASE_ROCMFP_CDNA(GGML_TYPE_Q4_0_ROCMFP4,      GGML_CUDA_MMQ_SRAM_LAYOUT_Q3_K);
    CASE_ROCMFP_CDNA(GGML_TYPE_Q4_0_ROCMFP4_FAST, GGML_CUDA_MMQ_SRAM_LAYOUT_Q8_0);
    CASE_ROCMFP_CDNA(GGML_TYPE_Q4_0_ROCMI4,       GGML_CUDA_MMQ_SRAM_LAYOUT_Q8_0);
    CASE_ROCMFP_CDNA(GGML_TYPE_Q3_0_ROCMFPX,      GGML_CUDA_MMQ_SRAM_LAYOUT_Q3_K);
    CASE_ROCMFP_CDNA(GGML_TYPE_Q2_0_ROCMFPX,      GGML_CUDA_MMQ_SRAM_LAYOUT_Q3_K);
    CASE_ROCMFP_CDNA(GGML_TYPE_Q6_0_ROCMFPX,      GGML_CUDA_MMQ_SRAM_LAYOUT_Q3_K);
    CASE_ROCMFP_CDNA(GGML_TYPE_Q8_0_ROCMFPX,      GGML_CUDA_MMQ_SRAM_LAYOUT_Q8_0);
#undef CASE_ROCMFP_CDNA
